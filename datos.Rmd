...
En R los datos pueden ser de diferentes tipos. Cada tipo tiene características particulares que los distinguen de los demás. Entre otras cosas algunas operaciones sólo pueden realizarse con tipos de datos específicos.
...
knitr::include_graphics("figures/tipoDatoR.PNG")
```
...
En R existen diferentes funciones. Éstas han sido diseñadas para realizar una labor específica Se identifican por tener un nombre particular seguido por unos paréntesis `()`. Dentro de los paréntesis uno puede agregar diferentes argumentos que permitirán controlar los ajustes de la función. Ejemplo:
...
```{r out.width="80%", fig.align='center'}
knitr::include_graphics("figures/operadorAsignacion.PNG")
```
